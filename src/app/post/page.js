...
// Langkah 1: Tandai sebagai Komponen Klien agar bisa pakai Hooks
"use client";

// Langkah 2: Import Hooks yang kita butuhkan dari React
...
hover:shadow-xl transition-shadow"
          >
            <h2 className="text-xl font-bold mb-2 font-heading truncate">
              {post.title}
            </h2>
